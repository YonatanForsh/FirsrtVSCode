...
function Mission1(militaryUnit)
{
    return `Chief of staff name : ${militaryUnit.commandStructure.chiefOfStaff.name}
            Chief of staff rank : ${militaryUnit.commandStructure.chiefOfStaff.rank}
            Chief of staff phone :${militaryUnit.commandStructure.chiefOfStaff.contact.phone}`;
}
...
function Mission2(militaryUnit)
{
    ...
    const sumInText = sumOfSoldiers.toString();
    return sumInText;
}
